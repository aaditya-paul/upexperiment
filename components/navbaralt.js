                      ...
                      <>
                        {item.children && item.children.length > 0 ? (
                          ...
                          <Link
                            href={item.href}
                            key={index + item.label}
                            className="rounded-full px-5 py-2 font-light text-gray-600 outline-none ring-blue-100 hover:text-blue-500 focus-visible:text-blue-500 focus-visible:ring-2 dark:text-gray-400"
